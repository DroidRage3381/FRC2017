...
public class DriveTrain extends Subsystem {
    ...
    private final Relay green = RobotMap.driveTrainGreen;
    private final AnalogInput gearSensor = RobotMap.driveTrainGearSensor;
    ...
    public void disableGreenLED (){
    	green.set(Value.kOff);
    }

    public void enableGreenLED (){
    	green.set(Value.kOn);
    	green.setDirection(Direction.kForward);
    }
