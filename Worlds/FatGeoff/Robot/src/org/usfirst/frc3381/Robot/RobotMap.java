...
public class RobotMap {
    ...
    public static Relay driveTrainGreen;
    ...
    public static void init() {
        ...
        driveTrainGreen = new Relay(1);
        LiveWindow.addActuator("DriveTrain", "Green", driveTrainGreen);
        
        driveTrainGearSensor = new AnalogInput(0);
        LiveWindow.addSensor("DriveTrain", "GearSensor", driveTrainGearSensor);
