 ...
 *
 */
public class AutoCenterGearOnly extends Command {
...
SmartDashboard.putNumber("Turn Angle", Robot.driveTrain.getHeading());
    	...
    	Double speed = RobotMap.prefs.getDouble( "Auto Straight Speed", -0.6);
    	Double turn = RobotMap.prefs.getDouble( "Auto Straight Drift", 0);
    	
    	Robot.driveTrain.driveWithValues(speed, turn);
    	
    }

    // Make this return true when this Command no longer needs to run execute()
    protected boolean isFinished() {
    	Double distance = RobotMap.prefs.getDouble( "Auto Straight Distance #3", 75);
